...
const VendorPriceBoxSingle: FC<VendorPriceBoxProps> = ({
	name,
	type,
	price,
	list,
	...
	return (
		<div className={styles.singlePriceBox}>
			...
			/>
			<div className={styles.full_width_price_header}>
				<Heading
					size={'h4'}
					variant={'semibold'}
			...
			<div className={styles.full_width_price_body}>
				...
				<div className={styles.full_width_price_desc}>
					<Paragraph
...
export default VendorPriceBoxSingle;
