...
import styles from './SoftwareCTA.module.css';
...
const SoftwareCTA: FC<SoftwareCTAProps> = ({ open, onClose, type }) => {
						...
						<div className="grid grid-cols-1 lg:grid-cols-2">
							<div className={cn(styles.left, 'hidden lg:block')}>
								...
								>
									...
									for athenahealth EMR Software
								</Paragraph>
								<Image
									src={'/images/software_form.png'}
									width={250}
									height={350}
									alt="pricing"
									className="mx-auto"
