...
import styles from './ComparePricing.module.css';
...
const ComparePricing: FC<ComparePricingProps> = ({ open, onClose, vendor }) => {
					...
					<Dialog.Content className={styles.DialogContent}>
						<div className="grid grid-cols-1 lg:grid-cols-2">
							<div className={cn(styles.left, 'hidden lg:block')}>
								...
								<Image
									src={'/images/compare_pricing.png'}
									width={320}
									height={330}
									alt="pricing"
								...
								>
									<div className="flex flex-col items-center justify-center mt-8">
										...
										<div className="flex items-center justify-start w-full mt-6">
											{isSubmitted ? (
												<Paragraph className="text-white">
													Thank you for submitting your request. We will get
													back to you shortly.
												</Paragraph>
											) : (
